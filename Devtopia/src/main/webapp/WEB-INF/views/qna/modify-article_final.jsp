 ...
 <jsp:include page="../common/navBar.jsp"></jsp:include>
    ...
    <div class="main-contents">
        <section class="write-article-wrapper">
            ...
            <br>
            <br>
			<form action="modifyQnAArticleAction.do" class="write-article-head" method="post">
                    ...
                    <c:if test="${Article.writer == sessionScope.userId }">
	                    <div class="write-article-button-wrapper">
	                        <div class="article-cotroller">
	                            ...
	                            <button type="button" onclick="location.href='deleteQnAArticleAction.do?postNo=${Article.postNo }'">게시글 삭제</button>
	                            <!-- <button>수정</button>
	                            <button>삭제</button> -->
	                        </div>
	                    </div>
