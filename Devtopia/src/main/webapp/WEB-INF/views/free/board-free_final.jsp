...
<!-- Devtopia css -->
<link rel="stylesheet" href="./resources/css/board-free.css">
	...
	<div class="paigination-wrapper">
		<ul class="pagination">
			<li id="Previous-page"><a
				href="pageNationFreeArticleAction.do?arrowDirection=left"
			...
			<li id="next-page"><a
				href="pageNationFreeArticleAction.do?arrowDirection=right"
